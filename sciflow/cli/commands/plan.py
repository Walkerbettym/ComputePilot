"""sciflow plan — generate a workflow from a natural language description."""
...
from sciflow.agent.provider import OpenAIProvider
from sciflow.workflow.schema import dump_workflow
...
def plan(
    ...
    show_cost: bool = typer.Option(
        True, "--cost/--no-cost", help="Show estimated cost"
    ),
) -> None:
