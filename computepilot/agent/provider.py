...
class OpenAIProvider:
    ...
    def __init__(
        ...
        self._api_key = api_key or os.environ.get("COMPUTEPILOT_LLM_API_KEY", "")
        self._base_url = (
            base_url or os.environ.get("COMPUTEPILOT_LLM_BASE_URL", "https://api.openai.com/v1")
        ).rstrip("/")
        self._model = model or os.environ.get("COMPUTEPILOT_LLM_MODEL", _OPENAI_DEFAULT_MODEL)
